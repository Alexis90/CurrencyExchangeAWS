...
public class CurrencyInformation {
	...
	protected static double getEuro_chf_course() {
		return euro_chf_course;
	}
	protected static double getEuro_dollar_course() {
		return euro_dollar_course;
	}
	protected static double getEuro_pound_course() {
		return euro_pound_course;
	}
	protected static double getChf_euro_course() {
		return chf_euro_course;
	}
	protected static double getDollar_euro_course() {
		return dollar_euro_course;
	}
	protected static double getPound_euro_course() {
